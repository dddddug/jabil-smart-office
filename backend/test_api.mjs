...
const query = `
  ...
  excluded_areas AS (
    SELECT area_name FROM (
      SELECT 'SMT-Line2' as area_name UNION ALL SELECT 'SMT-Line3' as area_name UNION ALL
      SELECT 'SMT-Line4' as area_name UNION ALL SELECT 'SMT-Line6' as area_name UNION ALL
      SELECT 'SMT-Line7' as area_name UNION ALL SELECT 'SMT-Line8' as area_name UNION ALL
      SELECT 'SMT-Line9' as area_name UNION ALL SELECT 'SMT-Line10' as area_name UNION ALL
      SELECT 'SMT-Line11' as area_name UNION ALL SELECT 'SMT-Line12' as area_name UNION ALL
      SELECT 'SMT-Line13' as area_name UNION ALL SELECT 'SMT-Line14' as area_name UNION ALL
      SELECT 'SMT-Line15' as area_name UNION ALL SELECT 'SMT-Line16' as area_name UNION ALL
      SELECT 'SMT-Line17' as area_name UNION ALL SELECT 'SMT-Line18' as area_name
    ) excluded
  ),
  shift_duration_rules AS (
    SELECT id, department_id, shift_name, duration_hours
  ...
  daily_arrangements AS (
    ...
    WHERE (wa.arrangement_date AT TIME ZONE 'Asia/Shanghai')::date >= '2026-08-19'::date
      AND (wa.arrangement_date AT TIME ZONE 'Asia/Shanghai')::date <= '2026-09-18'::date
...
try {
  ...
  const result = await pool.query(query, ['2026-08-19', '2026-09-18', 20]);
