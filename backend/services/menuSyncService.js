...
const menuConfig = {
  ...
  items: [
    ...
    { code: 'stockroom-urgent-pull', name: 'Stockroom Urgent Pull', icon: '📦', routeName: 'stockroom-urgent-pull', group: 'data-center', sortOrder: 5 },
    ...
    { code: 'warehouse-monitor', name: '物料进出效期监控', icon: '📦', routeName: 'warehouse-monitor', group: 'warehouse-management', sortOrder: 5 },
    { code: 'material-package', name: '物料包装信息', icon: '📦', routeName: 'material-package', group: 'warehouse-management', sortOrder: 6 },
    { code: 'missing-material-package', name: '待填充料号', icon: '📦', routeName: 'missing-material-package', group: 'warehouse-management', sortOrder: 7 },
    { code: 'warehouse-diff-registration', name: '收发差异登记', icon: '📝', routeName: 'warehouse-diff-registration', group: 'warehouse-management', sortOrder: 8 },
    { code: 'warehouse-return', name: '回仓申请', icon: '📥', routeName: 'warehouse-return', group: 'warehouse-management', sortOrder: 9 },
    ...
    { code: 'stockroom-urgent-pull-config', name: 'Stockroom Urgent Pull 配置', icon: '⚙️', routeName: 'stockroom-urgent-pull-config', group: 'rules-config', sortOrder: 7 },
    ...
    { code: 'employee-hourly-rate-config', name: '员工时薪配置', icon: '💵', routeName: 'employee-hourly-rate-config', group: 'rules-config', sortOrder: 9 },
    { code: 'welfare-base-config', name: '福利基础配置', icon: '🎁', routeName: 'welfare-base-config', group: 'rules-config', sortOrder: 10 },
